...
The `fast-gpio` utility can be used to generate a software-based PWM signal using a GPIO pin. See the [Using the GPIOs](/omega2-legacy/Doing-Stuff/Using-GPIOs#fast-gpio) article for full details on the `fast-gpio` utility.
...
> See [Using PWM Expansion](/omega2-legacy/Doing-Stuff/Expansions/Using-the-PWM-Expansion#using-pwm-expansion) for details on the PWM expansion module.
