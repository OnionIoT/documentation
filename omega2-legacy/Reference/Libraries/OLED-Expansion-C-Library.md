---
title: "OLED Expansion C Library"
---
...
The Onion OLED Expansion C library is used in the implementation of [the `oled-exp` command line tool.](/omega2-legacy/Doing-Stuff/Expansions/Using-the-OLED-Expansion#using-the-oled-expansion).
