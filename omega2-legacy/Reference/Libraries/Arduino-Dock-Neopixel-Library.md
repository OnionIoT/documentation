---
title: "Arduino Dock Neopixel Library"
---
...
Example code that uses the `onionNeopixel` class can be found in the source code for the `neopixel-tool` command line utility described in the Controlling Neopixels tutorial. Please take a look at the [neopixel-tool GitHub repo](https://github.com/OnionIoT/neopixel-tool).
