[Connect to the Omega2 command line through serial](/omega2-docs/quickstart/serial-command-line). Then power on the device **and** press the SW Reset button at the same time. 
