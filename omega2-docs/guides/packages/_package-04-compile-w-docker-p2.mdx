...
**Step 5:** Make sure you're **outside of the Docker container** and in the top level directory of the source code. Then run `ls -l output` to see the contents of the output directory.
