...
1. Flash the latest available Omega2+ firmware to your device – see [installing the new firmware article](/omega2-docs/firmware/installing-firmware)
2. Connect the WiFi – see the [WiFi article](/omega2-docs/networking/wifi)
