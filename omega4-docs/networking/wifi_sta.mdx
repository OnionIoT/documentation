...
Set the radio to STA mode, disable HE/AX, and point the interface at your SSID:
```bash
uci set wireless.radio0.disabled='0'
uci set wireless.radio0.he='0'
uci set wireless.radio0.band='5g'        # use '2g' if your AP is 2.4 GHz only
uci set wireless.radio0.channel='36'     # or leave unset for auto
uci set wireless.radio0.htmode='HT40'    # stay on HT if your wpad lacks 11ac
...
ifconfig phy0-sta0                   # UP and RUNNING once associated
```
...
- One role at a time: enabling STA mode disables the AP interface on this single radio; switch back to AP by restoring `mode='ap'` and `network='lan'`.
