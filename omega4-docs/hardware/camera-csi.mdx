...
Use this page to capture still frames and validate the camera path. For H.264 recording and streaming, see [Video Encoder (VENC)](/omega4/hardware/video-encoder). For object detection and RKNN inference, see [NPU (Edge AI)](/omega4/hardware/npu-rknn).
